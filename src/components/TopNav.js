  ...
  return (
    <div className="max-w-[1520px]  mx-auto flex justify-between items-center p-4">
      <div className="flex items-center">
        ...
        <div className="hidden lg:flex items-center bg-gray-200 rounded-full p-1 text-[14px] mr-[200px]">
        ...
        <div className="bg-gray-200 rounded-full flex m items-center px-2 py-1  w-[200px] sm:w-[200px] lg:w-[500px] mr-[400px]">
        ...
        : "fixed top-0 left-[-100%] w-[300px] h-screen bg-white z-10 duration-200"
            ...
            <AiOutlineClose  onClick={()=>setSideNav(!sideNav)} size={25} className="absolute right-4 cursor-pointer"/>
